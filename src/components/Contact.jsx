  ...
  return (
    <div className="flex flex-col items-center gap-4" id="Contact">
      ...
      <div className="flex gap-3 mb-8">
        <a href="https://www.linkedin.com/in/ashish-dubbewar" target="_blank"><img src={linkedin} alt=""/></a>
        <a href="https://www.instagram.com/a_dubbewar07/" target="_blank"><img src={instagram} alt="" /></a>
